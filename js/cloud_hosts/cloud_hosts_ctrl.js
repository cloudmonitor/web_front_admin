...
angular.module('myApp')
    ...
    .controller('CloudHostsCtrl', ['$scope', '$http',
        function($scope, $http) {
            // 初始化
            $scope.itemPerPage = 4;
            $scope.currentPage = 1;
            ...
            var req = {
                method: 'GET',
                url: config['host'] + '/v1.0/admin/all_instances',
                params: {
            ...
            $scope.pageChangeHandler = function(newPageNumber) {
                console.info(newPageNumber);
                console.info($scope.vms);
            }
        }
    ]);
